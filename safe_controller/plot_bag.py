...
import numpy as np
import matplotlib
matplotlib.use("TkAgg")   # use "TkAgg" if GUI available; "Agg" for headless
...
def update(frame):
    ...
    return [im_rgb, im_gray, line_lane, line_lin, line_ang, line_cbfL, line_cbfR]
